...
column1 = dbc.Col (
    [    #species_location_dropdown
        ...
        html.Div(
            ...
            dcc.Slider(id="video-count", min=100, max=10000, step=1000, value=100),], className="mb-3"),
